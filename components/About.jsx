      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-[#334756]">
            ...
            which he developed from his background in tax. He is always looking
            for new opportunities to improve his skills and grow as a developer
            and is not afraid to put in the extra effort to achieve success.
            With an organized and efficient approach, George approaches tasks
            with purpose and precision, similar to someone who is dedicated to
            hitting their fitness goals.
          </p>
          <p className="py-2 text-[#334756]">
            In his free time, George enjoys exploring new things, experiencing
            different cultures, and having fun. He loves travelling and going on
          ...
          <p>
            ...
            ways to live life to the fullest. If you&apos;re interested in
            learning more about George&apos;s skills and experience, don&apos;t
            hesitate to reach out to him at gwmkwan@gmail.com!
          </p>
          <Link href="/#projects">
