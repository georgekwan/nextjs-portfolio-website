      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-[#334756]">
            ...
            &quot;Live Life Like A Movie&quot; attitude, meaning he takes risks,
            follows his curiosity, and lives life on his own terms. He is
          ...
          <p className="py-2 text-[#334756]">
            ...
            ways to live life to the fullest. If you are interested in learning
            more about George&apos;s skills and experience, don&apos;t hesitate
            to reach out to him!
          </p>
